...
<Frame>
  ![New Assistant](/images/new-assistant.png)
</Frame>
...
<Frame>
  ![New Create Assis](/images/new-create-assis.png)
</Frame>
...
<Steps>
  ...
  <Step title="Set Opening and Closing Messages">
    ...
    | **Opening: AI generates it** | Orato crafts a natural opening based on the caller's name and context |
