...
<Frame>
  ![New Conversation](/images/new-conversation.png)
</Frame>
...
<Tabs>
  <Tab title="🎙️ Voice">
    ...
    Each voice conversation log includes: contact name, call duration, an AI-written summary, the outcome, the date and time, and a full transcript with a recording.
  </Tab>
  <Tab title="💬 Chat">
...
| **Type** | Voice or Chat |
| **Duration** | How long did the conversation last in minutes and seconds |
...
<AccordionGroup>
  ...
  <Accordion title="Outcome">
    The result of the conversation, as determined by your assistant, base on the criteria you defined in its instructions.
  </Accordion>
...
| --- | --- |
| **Qualified** | The contact met the criteria that your assistant was given |
